...
<?php require RUTA_APP . '/vistas/includes/headerAdministrador.php'; ?>
    <form class="formulario" action="<?php echo RUTA_URL;?>paginas/editarRecolector/<?php echo $datos['id_recolector'];?>" method="POST">
    <table class="tblIngresar">
        <th>Editar recolector</th>
        <tr>
        ...
        <tr>
            ...
            <td><input type="submit" value="Editar recolector" id="sub_conf_ingresar"></td>
        </tr>
    </table>
    </form>
